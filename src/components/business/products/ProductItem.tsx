...
const ProductItem: FC<IProps> = ({ product }) => {
  ...
  const getProducts = async () => {
    const response = await fetchProducts({ orderId: product.order });
  ...
  return (
    <div className={`w-full py-2 px-4 border border-gray-200 rounded-lg mb-1 hover:shadow-soft transition duration-300 flex items-center`}>
      <div className="flex gap-3 items-center w-[500px]">
